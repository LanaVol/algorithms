// Бульбашкове сортування - попарно перевіряє яке з чисел є меншим і переставляє наперед(більші числа ставляться назад), таким чином число як бульбашка вспливає
const arr = [
  2, 5, 3, 1, 0, 12, 10, 6, 9, 11, 7, 6, 2, 1, 5, 16, 25, -1, -5, 10, 6, 9, 11,
  7, 6, 2, 1, 5, 16, 25, -1, -5,
]; //порівняно з Хоара -  тут 1024 ітерацій, а при Хоара - 161 ітерацій
